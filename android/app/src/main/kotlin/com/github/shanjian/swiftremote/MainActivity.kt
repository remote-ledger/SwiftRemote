...
import com.github.shanjian.swiftremote.audio.AudioCapturedIrPlayer
import com.github.shanjian.swiftremote.audio.AudioIrTransmitter
import com.github.shanjian.swiftremote.audio.AudioIrLearner
import com.github.shanjian.swiftremote.huawei.HuaweiIrLearner
import com.github.shanjian.swiftremote.lg.LgIrLearner
import com.github.shanjian.swiftremote.BaseQuickTileService
...
class MainActivity : FlutterActivity() {
    ...
    /**
     * Carries the transmitter settings over from the pre-SwiftRemote prefs
     * file. Runs once: the legacy file is emptied after the copy, and an
     * install that never wrote one does nothing.
     */
    private fun migrateLegacyPrefs(target: SharedPreferences) {
    ...
    private fun setUsbAttachAliasEnabled(enabled: Boolean) {
        ...
        val cn = ComponentName(applicationContext, "com.github.shanjian.swiftremote.UsbAttachAlias")
    ...
    companion object {
        private const val PREFS_NAME = "swiftremote_prefs"
        private const val LEGACY_PREFS_NAME = "ir_blaster_prefs"
        private const val CHANNEL = "com.github.shanjian.swiftremote/irtransmitter"
        private const val EVENT_CHANNEL = "com.github.shanjian.swiftremote/irtransmitter_events"
        private const val CONTROL_CHANNEL = "com.github.shanjian.swiftremote/irtransmitter_controls"
        private const val QUICK_TILE_CHANNEL = "com.github.shanjian.swiftremote/irtransmitter_quick_tile"
        private const val HOME_WIDGET_CHANNEL = "com.github.shanjian.swiftremote/irtransmitter_home_widget"
        private const val SHORTCUTS_CHANNEL = "com.github.shanjian.swiftremote/app_shortcuts"
        private const val UPDATE_CHANNEL = "com.github.shanjian.swiftremote/app_update"
        private const val EXTRA_SHORTCUT_ACTION = "com.github.shanjian.swiftremote.SHORTCUT_ACTION"
